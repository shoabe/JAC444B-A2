...
private void zoomIn() {
	...
	if (n >= 0 && n < 19) {
		ttfZoom.setText(Integer.toString(n+=1));		
	}
}
...
private void getCity(ItemEvent ie) {
	if (ie.getSource() == boxCities1) {
		...
		case 1: //Sapporo, Hokkaido
			...
			ttfLon.setText("141.354376");
			break;
		case 2: //Sendai, Miyagi
			ttfLat.setText("38.268215");
			ttfLon.setText("140.869356");
			break;
		case 3: //Tokyo, Tokyo
			ttfLat.setText("35.689488");
			ttfLon.setText("139.691706");
			break;
		case 4: //Osaka, Osaka
			ttfLat.setText("34.693738");
			ttfLon.setText("135.502165");
			break;
		case 5: //Kyoto, Kyoto
			ttfLat.setText("35.011636");
			ttfLon.setText("135.768029");
			break;
		case 6: //Fukuoka, Fukuoka
			ttfLat.setText("33.590355");
			ttfLon.setText("130.401716");
			break;
		case 7: //Okinawa, Okinawa
			ttfLat.setText("26.212401");
			ttfLon.setText("127.680932");
			break;
		default:
		...
		case 1: //Toronto
			...
			ttfLon.setText("-79.383184");
			break;
		case 2: //Vancouver
			ttfLat.setText("49.261226");
			ttfLon.setText("-123.113927");
			break;
		case 3: //Montreal
			ttfLat.setText("45.50867");
			ttfLon.setText("-73.553992");
			break;
		case 4: //Quebec
			ttfLat.setText("46.803283");
			ttfLon.setText("-71.242796");
			break;
		default:
...
private void initComponents() {
  ...
  panel11 = new JPanel();
  boxCities1 = new JComboBox();
  boxCities2 = new JComboBox();
  lblJapan = new JLabel();
  ...
  //======== dialogPane ========
  {
  	...
  	//======== contentPanel ========
  	{
  		...
  		contentPanel.setLayout(new TableLayout(new double[][] {
  			{TableLayout.FILL},
  			{TableLayout.PREFERRED, TableLayout.FILL, TableLayout.FILL, TableLayout.PREFERRED}}));
  		...
  		//======== panel1 ========
  		{
  			...
  			panel1.add(btnZoomIn, new TableLayoutConstraints(2, 2, 2, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
  			...
  			panel1.add(btnSaveMap, new TableLayoutConstraints(5, 2, 5, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
  		...
  		//======== panel11 ========
  		{
  			...
  			panel11.add(boxCities1, new TableLayoutConstraints(3, 0, 3, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
  			
  			lblCanada.setText("Canada");
  			lblCanada.setHorizontalAlignment(SwingConstants.RIGHT);
...
private JComboBox boxCities1;
private JComboBox boxCities2;
